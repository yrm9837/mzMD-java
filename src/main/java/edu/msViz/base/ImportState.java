...
public class ImportState extends Observable
{
    ...
    public enum ImportStatus {
        ...
        LOADING_MZDB,         // loading mzDB format (fast)
    ...
    public String getStatusString()
    {
        ...
        switch(this.importStatus){
            ...
            // building mzDB from parsed mzml
            case CONVERTING:
            ...
            case LOADING_MZDB:
                if (this.mzTreeFilePath == null)
                    return "Connecting to MzFB";
                else
                    return "Loading MzDB: " + this.mzTreeFilePath;
